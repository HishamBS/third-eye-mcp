 ...
 */
import { EyeId, EyeStageToken, EyeStatusCode, EyeTag, EnvelopeField, SemanticColor, EmojiIcon } from '@third-eye/constants';
export const KYUUBI_BLUEPRINT = {
    metadata: {
        eyeId: EyeId.KYUUBI,
        name: 'Kyuubi',
        description: 'Transforms clarified intent into a structured creative brief',
        version: '1.0.0',
        capabilities: ['prompt_structuring', 'requirements_synthesis'],
    },
...
//# sourceMappingURL=kyuubi.blueprint.js.map