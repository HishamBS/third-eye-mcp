          ...
          claims: [
            {
              ...
              suggestion:
                "Add supporting data, citations, examples, or reasoning",
            },
          ],
  ...
  describe("Evidence Detection", () => {
    ...
    it("should detect examples as moderate evidence", () => {
      const envelope = {
        ...
        suggestions: [
          "Consider adding data or citations for stronger evidence",
        ],
        confidence: 75,
        metadata: {
          evidenceScore: 100,
  ...
  describe("Evidence Quality Assessment", () => {
    ...
    it("should flag hedging language as weak evidence", () => {
      const envelope = {
        ...
        suggestions: [
          "Replace hedging language with concrete evidence or data",
        ],
        confidence: 25,
        metadata: {
          evidenceScore: 0,
