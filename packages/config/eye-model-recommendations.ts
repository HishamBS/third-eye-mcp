...
export const EYE_MODEL_MAP: Record<ProviderId, Record<string, ModelRecommendation>> = {
  groq: {
    overseer: {
      ...
      reasoning: 'Llama 3 70B excels at structured routing decisions with function calling',
      strengths: ['Routing logic', 'Decision-making', 'Fast inference'],
      expectedSuccessRate: '95-98%'
    },
    sharingan: {
      model: 'llama-3-groq-70b-tool-use',
      reasoning: 'Llama 3 70B identifies ambiguities effectively with strong reasoning',
      strengths: ['Ambiguity detection', 'Question generation', 'Context analysis'],
      expectedSuccessRate: '95-98%'
    },
    kyuubi: {
      model: 'llama-3-groq-70b-tool-use',
      reasoning: 'Llama 3 70B provides structured guidance with consistent formatting',
      strengths: ['Structuring', 'Framework creation', 'Guidance quality'],
      expectedSuccessRate: '95-98%'
    },
    jogan: {
      model: 'llama-3-groq-70b-tool-use',
      reasoning: 'Llama 3 70B validates intent clearly with strong comprehension',
    ...
    mangekyo: {
      model: 'llama-3-groq-70b-tool-use',
      reasoning: 'Llama 3 70B performs thorough code review with security awareness',
    ...
    byakugan: {
      model: 'llama-3-groq-70b-tool-use',
      reasoning: 'Llama 3 70B provides final review with comprehensive analysis',
  ...
  openrouter: {
    overseer: {
      ...
      reasoning: 'Llama 3.3 70B provides structured routing with excellent tool use',
      strengths: ['Structured output', 'Fast routing', 'Reliable decisions'],
      expectedSuccessRate: '85-95%'
    },
    sharingan: {
      model: 'qwen/qwen-2.5-72b-instruct',
      reasoning: 'Qwen 2.5 72B excels at reasoning and asking clarifying questions',
      strengths: ['Deep reasoning', 'Question quality', 'Context understanding'],
      expectedSuccessRate: '85-95%'
    },
    kyuubi: {
      model: 'meta-llama/llama-3.3-70b-instruct',
    ...
    rinnegan: {
      ...
      reasoning: 'DeepSeek R1 excels at complex planning and feasibility analysis',
      strengths: ['Advanced reasoning', 'Planning expertise', 'Feasibility assessment'],
      expectedSuccessRate: '85-95%'
    },
    mangekyo: {
      model: 'qwen/qwen-2.5-72b-instruct',
      reasoning: 'Qwen 2.5 72B performs thorough code review with deep analysis',
    ...
    byakugan: {
      model: 'qwen/qwen-2.5-72b-instruct',
      reasoning: 'Qwen 2.5 72B provides final review with comprehensive reasoning',
  ...
  ollama: {
    ...
    sharingan: {
      model: 'qwen2.5:7b',
      reasoning: 'Qwen 2.5 7B with constrained generation ensures perfect JSON output',
  ...
  lmstudio: {
    overseer: {
      ...
      reasoning: 'Llama 3.2 8B GGUF provides fast local routing with grammar sampling',
    ...
    kyuubi: {
      model: 'Qwen2.5-7B-Instruct-GGUF',
      reasoning: 'Qwen 2.5 7B GGUF creates structured guidance with grammar control',
    ...
    byakugan: {
      model: 'Qwen2.5-7B-Instruct-GGUF',
      reasoning: 'Qwen 2.5 7B GGUF provides final review with structured output',
      strengths: ['Grammar sampling', 'Structured output', 'Local privacy'],
      expectedSuccessRate: '100%'
    }
  }
...
export const MODEL_OVERRIDE_WARNINGS = {
  ...
  local_only: 'Local models (Ollama/LM Studio) use JSON Schema for 100% reliability',
  remote_api: 'Remote APIs (Groq/OpenRouter) use function calling for best results'
} as const;
