...
export const modelsCache = sqliteTable(
  "models_cache",
  {
    id: text().primaryKey(), // UUID
    provider: text().notNull(),
...
export const eyesRouting = sqliteTable(
  "eyes_routing",
  {
    id: text().primaryKey(), // UUID
    eyeId: text()
...
export const executionSteps = sqliteTable(
  "execution_steps",
  {
    ...
    runId: text()
      .notNull()
      .references(() => pipelineQueue.runId), // FK
    nodeId: text().notNull(),
...
export const nodeConfigs = sqliteTable(
  "node_configs",
  {
    id: text().primaryKey(), // UUID
    pipelineId: text()
...
export const eyeLeaderboard = sqliteTable(
  "eye_leaderboard",
  {
    id: text().primaryKey(), // UUID
    eyeId: text()
...
export const personaBlueprints = sqliteTable(
  "persona_blueprints",
  {
    id: text().primaryKey(), // UUID
    eyeId: text()
...
export const pipelineStates = sqliteTable("pipeline_states", {
  sessionId: text()
    .primaryKey()
    .references(() => sessions.id), // Session ID as PK
...
export const humanResponses = sqliteTable("human_responses", {
  ...
  questionId: text()
    .notNull()
    .references(() => pendingQuestions.id), // FK
  sessionId: text()
    .notNull()
    .references(() => sessions.id), // FK
