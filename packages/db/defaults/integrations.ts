...
export const DEFAULT_INTEGRATIONS: IntegrationSeed[] = [
  {
    ...
    description:
      "Register the bridge with Anthropic CLI once; both Claude Code and Claude Desktop read the shared MCP registry after you approve the trust prompt",
    status: "official",
    platforms: ["macos", "windows", "linux"],
    configType: "json",
    configFiles: [{ platform: "all", path: "CLI command (see below)" }],
    configTemplate: `claude mcp add third-eye -- ${CLI_EXEC} server`,
    setupSteps: [
      {
        title: "Run CLI Command",
        description:
          "Execute the command below to register Third Eye with Claude",
        code: "config",
      },
      {
        title: "Approve Trust Prompt",
        description:
          "Approve the trust prompt when Claude Code or Desktop starts",
        code: null,
      },
      {
        title: "Toggle Server On (Desktop)",
        description:
          "In Claude Desktop, go to Settings → Tools and toggle the server on",
        code: null,
      },
      {
        title: "Verify Connection",
        description:
          "Look for the hammer/tools icon confirming MCP server is active",
        code: null,
      },
    ],
    docsUrl:
      "https://docs.anthropic.com/en/docs/build-with-claude/claude-desktop/model-context-protocol",
    enabled: true,
    displayOrder: 1,
  },
  {
    ...
    description:
      "AI-first code editor with native MCP integration. Supports global and project-specific configs.",
    status: "official",
    platforms: ["macos", "windows", "linux"],
    configType: "json",
    configFiles: [
  ...
  "mcpServers": {
    ...
    setupSteps: [
      ...
      },
      {
        ...
        description:
          'Click "Add new global MCP server" or create ~/.cursor/mcp.json',
        code: null,
      },
      {
  ...
  },
  {
    ...
    description:
      "Modern terminal with AI and experimental MCP support. Add servers via UI or startup commands.",
    status: "experimental",
...
Type: stdio`,
  ...
  },
  {
    ...
    description:
      "High-performance editor with MCP support via extensions or settings.json configuration.",
    status: "official",
    platforms: ["macos", "linux"],
    configType: "json",
    configFiles: [
  ...
  },
  {
    ...
    logoUrl:
      "https://raw.githubusercontent.com/continuedev/continue/main/images/icon.png",
    description:
      "Continue extension adds AI pair programming with MCP tool support.",
    status: "community",
    platforms: ["macos", "windows", "linux"],
    configType: "json",
    configFiles: [
  ...
  },
  {
    ...
    description:
      "Cline extension integrates MCP servers for agent workflows in VS Code.",
    status: "community",
    platforms: ["macos", "windows", "linux"],
    configType: "json",
    configFiles: [{ platform: "all", path: "<workspace>/.cline/config.json" }],
    configTemplate: `{
  "mcpServers": {
    "third-eye": {
      "command": "bunx",
  ...
  },
  {
    ...
    configFiles: [
      {
        platform: "all",
        path: "ChatGPT → Settings → Actions → Manage Actions",
      },
    ],
...
`,
  ...
  },
  {
    ...
    platforms: ["macos", "windows", "linux"],
    configType: "json",
    configFiles: [{ platform: "all", path: "~/.gemini/tools.json" }],
    configTemplate: `{
  "tools": {
    "third-eye": {
      "command": "bunx",
  ...
  },
  {
    ...
    slug: "opencode-cli",
    logoUrl:
      "https://raw.githubusercontent.com/OpenCode-ai/.github/main/profile/logo.png",
    description: "Terminal-first AI assistant with MCP support.",
    status: "community",
    platforms: ["macos", "linux"],
    configType: "json",
    configFiles: [{ platform: "all", path: "~/.opencode/mcp.json" }],
    configTemplate: `{
  "servers": {
    "third-eye": {
      "command": "bunx",
