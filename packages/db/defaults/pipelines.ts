...
export const DEFAULT_PIPELINES: Omit<NewPipeline, 'createdAt' | 'active'>[] = [
  {
    ...
    version: 1,
    description: 'Complete validation pipeline for new content creation tasks with all 8 eyes',
    category: 'default',
    workflowJson: {
      nodes: [
        ...
        { id: EyeId.RINNEGAN, type: 'eyeNode', position: { x: 400, y: 300 }, data: { eyeId: EyeId.RINNEGAN } },
        { id: EyeId.MANGEKYO, type: 'eyeNode', position: { x: 700, y: 300 }, data: { eyeId: EyeId.MANGEKYO } },
