...
for (const candidate of primaryCandidates) {
  ...
  console.log(
    `  ${candidate.name.padEnd(15)} ${candidate.hex}  ${ratio.toFixed(2)}:1 ${pass}`,
  );
...
console.log("=".repeat(80));
console.log(
  `primary:    ${bestPrimary.hex}  (${bestPrimary.name}) - ${bestPrimary.ratio.toFixed(2)}:1`,
);
console.log(
  `accent:     ${bestAccent.hex}  (${bestAccent.name}) - ${bestAccent.ratio.toFixed(2)}:1`,
);
console.log(
  `ink:        ${bestInk.hex}  (${bestInk.name}) - ${bestInk.ratio.toFixed(2)}:1`,
);
console.log(`paper:      ${darkBg}`);
console.log(`paperElev:  ${darkBgElev}`);
console.log(
  `outline:    ${bestOutline.hex}  (${bestOutline.name}) - ${bestOutline.ratio.toFixed(2)}:1`,
);
...
console.log("=".repeat(80));
console.log(
  `primary:    ${bestLightPrimary.hex}  (${bestLightPrimary.name}) - ${bestLightPrimary.ratio.toFixed(2)}:1`,
);
console.log(
  `accent:     ${bestLightAccent.hex}  (${bestLightAccent.name}) - ${bestLightAccent.ratio.toFixed(2)}:1`,
);
console.log(
  `ink:        ${bestLightInk.hex}  (${bestLightInk.name}) - ${bestLightInk.ratio.toFixed(2)}:1`,
);
console.log(`paper:      ${lightBg} (Purple-50)`);
console.log(`paperElev:  ${lightBgElev} (Purple-100)`);
console.log(
  `outline:    ${bestLightOutline.hex}  (${bestLightOutline.name}) - ${bestLightOutline.ratio.toFixed(2)}:1`,
);
