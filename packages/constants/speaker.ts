 ...
 */
export const SPEAKER_DISPLAY_NAMES: Readonly<Record<SpeakerType, string>> = Object.freeze({
 ...
 */
export const SPEAKER_ICONS: Readonly<Record<SpeakerType, string>> = Object.freeze({
 ...
 */
export const SPEAKER_COLOR_TOKENS: Readonly<Record<SpeakerType, string>> = Object.freeze({
