...
export type LeaderboardCategory = typeof LEADERBOARD_CATEGORIES[keyof typeof LEADERBOARD_CATEGORIES];
...
export const isLeaderboardCategory = (value: string): value is LeaderboardCategory => {
  return Object.values(LEADERBOARD_CATEGORIES).includes(value as LeaderboardCategory);
};
