 ...
 */
export const STATUS_BADGE_CONFIGS: Readonly<Record<ApprovalStatus, StatusBadgeConfig>> = Object.freeze({
 ...
 */
export function getStatusBadgeConfig(status: ApprovalStatus): StatusBadgeConfig {
