...
type RoutingMatrixMap = Readonly<
  Record<ContentDomain, RoutingMatrix>
>;

type RoutingRequirementsMap = Readonly<
  Record<RequestType, RoutingMatrixMap>
>;

export const ROUTING_CAPABILITY_REQUIREMENTS: RoutingRequirementsMap = Object.freeze({
  [RequestType.NEW_TASK]: Object.freeze({
    [ContentDomain.TEXT]: {
      guidance: Object.freeze([
        Object.freeze({
          allOf: Object.freeze([EyeCapability.CLARIFICATION, EyeCapability.AMBIGUITY_DETECTION]),
        }),
        Object.freeze({
      ...
      validation: Object.freeze([
        Object.freeze({
          anyOf: Object.freeze([EyeCapability.FACT_VALIDATION, EyeCapability.EVIDENCE_GROUNDING]),
        }),
        Object.freeze({
          allOf: Object.freeze([EyeCapability.INTENT_VALIDATION]),
          optional: true,
    ...
    [ContentDomain.CODE]: {
      ...
      validation: Object.freeze([
        ...
        Object.freeze({
          anyOf: Object.freeze([EyeCapability.QUALITY_ASSURANCE, EyeCapability.OUTCOME_SYNTHESIS]),
        }),
        Object.freeze({
          allOf: Object.freeze([EyeCapability.INTENT_VALIDATION]),
          optional: true,
  ...
  [RequestType.DRAFT_REVIEW]: Object.freeze({
    ...
    [ContentDomain.PLAN]: {
      ...
      validation: Object.freeze([
        Object.freeze({
          allOf: Object.freeze([EyeCapability.STRATEGIC_PLANNING, EyeCapability.QUALITY_ASSURANCE]),
        }),
        Object.freeze({
          allOf: Object.freeze([EyeCapability.INTENT_VALIDATION]),
          optional: true,
