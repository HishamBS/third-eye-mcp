...
export const CLARIFICATION_FIELDS: ReadonlyArray<ClarificationField> =
  Object.freeze([
...
export const isClarificationField = (
  value: unknown,
): value is ClarificationField =>
  typeof value === "string" &&
  CLARIFICATION_FIELD_SET.has(value as ClarificationField);

export const REQUIRED_CLARIFICATION_FIELDS: ReadonlyArray<ClarificationField> =
  CLARIFICATION_FIELDS;

export const CLARIFICATION_FIELD_PROMPTS: Readonly<
  Record<ClarificationField, string>
> = Object.freeze({
  [ClarificationFieldTokens.AUDIENCE]:
  ...
  [ClarificationFieldTokens.SCOPE]:
    "List any constraints, scope boundaries, or systems involved.",
  [ClarificationFieldTokens.SUCCESS_CRITERIA]:
...
export const CLARIFICATION_PROMPT_LOOKUP: Readonly<
  Record<string, ClarificationField>
> = Object.freeze(
  Object.entries(CLARIFICATION_FIELD_PROMPTS).reduce<
    Record<string, ClarificationField>
...
export const CLARIFICATION_FALLBACKS: Readonly<
  Record<ClarificationField, string>
> = Object.freeze({
 ...
 */
export const isClarificationFieldToken = (
  value: unknown,
): value is ClarificationField => isClarificationField(value);
