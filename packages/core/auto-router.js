...
function formatStrictnessDirective(strictness) {
...
function formatContextDirective(context) {
...
export class AutoRouter {
     ...
     */
    async analyzeTask(input, sessionId, providedSessionId, options = {}) {
     ...
     */
    async executeFlow(input, routing, providedSessionId, options = {}) {
        try {
     ...
     */
    async resumeFlow(sessionId, input, options = {}) {
        try {
