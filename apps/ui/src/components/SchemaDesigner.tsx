      ...
      <div className="rounded-xl border border-brand-outline/40 bg-brand-paper/50 p-4">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="rounded-lg bg-brand-accent px-6 py-2 font-semibold text-brand-foreground transition hover:bg-brand-accent/90 disabled:cursor-not-allowed disabled:opacity-50"
          >
            Add
          </button>
        </div>
