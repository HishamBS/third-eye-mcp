...
export function MarkdownRenderer({
  ...
  return (
    <div
      className={`prose prose-sm max-w-none [&_h1]:text-lg [&_h1]:font-semibold [&_h1]:text-brand-foreground [&_h1]:mb-3 [&_h1]:mt-4 [&_h2]:text-base [&_h2]:font-semibold [&_h2]:text-brand-foreground [&_h2]:mb-2 [&_h2]:mt-3 [&_h3]:text-sm [&_h3]:font-medium [&_h3]:text-brand-foreground [&_h3]:mb-1.5 [&_h3]:mt-2 [&_p]:text-sm [&_p]:text-brand-foreground/80 [&_p]:leading-relaxed [&_p]:mb-2 [&_strong]:text-brand-foreground [&_strong]:font-semibold [&_em]:text-brand-foreground/70 [&_em]:italic [&_a]:text-brand-primary [&_a]:underline [&_a]:underline-offset-2 [&_ul]:space-y-1 [&_ul]:my-2 [&_ol]:space-y-1 [&_ol]:my-2 [&_li]:text-sm [&_li]:text-brand-foreground/80 [&_li]:ml-4 [&_ul>li]:list-disc [&_ol>li]:list-decimal [&_blockquote]:border-l-2 [&_blockquote]:border-brand-primary/40 [&_blockquote]:pl-3 [&_blockquote]:py-1 [&_blockquote]:my-2 [&_blockquote]:bg-brand-paperElev/50 [&_blockquote]:rounded-r [&_code]:font-mono [&_code]:text-xs [&_code]:bg-brand-paperElev [&_code]:border [&_code]:border-brand-outline/40 [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded [&_pre]:bg-brand-ink [&_pre]:border [&_pre]:border-brand-outline/30 [&_pre]:rounded-lg [&_pre]:p-3 [&_pre]:my-3 [&_pre]:overflow-x-auto [&_pre_code]:bg-transparent [&_pre_code]:border-0 [&_pre_code]:p-0 [&_pre_code]:text-xs [&_table]:w-full [&_table]:my-3 [&_table]:border-collapse [&_th]:text-left [&_th]:text-xs [&_th]:font-medium [&_th]:text-brand-foreground [&_th]:bg-brand-paperElev [&_th]:px-3 [&_th]:py-2 [&_th]:border [&_th]:border-brand-outline/30 [&_td]:text-sm [&_td]:text-brand-foreground/80 [&_td]:px-3 [&_td]:py-2 [&_td]:border [&_td]:border-brand-outline/20 [&_tr:nth-child(even)_td]:bg-brand-paperElev/30 [&_hr]:border-brand-outline/30 [&_hr]:my-4 ${className}`}
