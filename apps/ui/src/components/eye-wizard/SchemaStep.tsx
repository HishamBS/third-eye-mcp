    ...
    <div className="space-y-8">
      ...
      <div>
        <div className="mb-4">
          ...
          <p className="mt-1 text-sm text-semantic-muted">{SCHEMA_LABELS.INPUT_SCHEMA_HELP}</p>
        </div>
        {errors.inputSchema && (
      ...
      <div>
        <div className="mb-4">
          ...
          <p className="mt-1 text-sm text-semantic-muted">{SCHEMA_LABELS.OUTPUT_SCHEMA_HELP}</p>
        </div>
        {errors.outputSchema && (
          <div className="mb-4 rounded-lg border border-status-error bg-status-error/10 p-3">
      ...
      <div className="rounded-lg border border-brand-accent/20 bg-brand-accent/5 p-4">
        <p className="text-sm text-brand-accent">
          💡 <strong>Tip:</strong> Define the structure of data your Eye expects to receive (Input
          Schema) and the structure of data it will return (Output Schema). This helps ensure data
          consistency and makes it easier to integrate with other systems.
        </p>
      </div>
    </div>
  );
