...
export const HELP_TEXT = {
  WIZARD_INTRO:
    "This wizard will guide you through configuring your Eye. You can navigate between steps and your progress will be saved.",
...
export const PROGRESS_LABELS = {
  STEP_OF: (current: number, total: number) =>
    `Step ${current + 1} of ${total}`,
  PROGRESS_PERCENTAGE: (current: number, total: number) =>
