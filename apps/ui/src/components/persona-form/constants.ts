...
export const MISSION_TEMPLATES = {
  GUIDANCE: 'Provide strategic guidance and recommendations based on input data, ensuring alignment with user goals and constraints.',
  VALIDATION: 'Validate input data for completeness, correctness, and consistency. Flag any issues or anomalies for user review.',
  TRANSFORMATION: 'Transform input data into a structured output format, applying necessary rules and business logic.',
  ANALYSIS: 'Analyze input data to extract insights, patterns, and actionable intelligence.',
  SYNTHESIS: 'Synthesize information from multiple sources into a coherent, unified response.',
} as const;
