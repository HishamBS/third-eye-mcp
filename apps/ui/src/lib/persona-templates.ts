...
export const PERSONA_TEMPLATES: readonly PersonaTemplate[] = [
  {
    ...
    data: {
      metadata: {
        ...
        name: "Code Reviewer",
        description:
          "Analyzes code submissions for quality, maintainability, and adherence to best practices",
        version: 1,
        capabilities: ["code-analysis", "quality-review", "best-practices"],
      },
      mission:
        "Review submitted code for quality, identify potential issues, suggest improvements, and ensure adherence to coding standards and best practices.",
      guidancePhase: {
        mission:
        ...
        example:
          '{"findings": ["Issue 1", "Issue 2"], "suggestions": ["Improvement 1"]}',
      },
      validationPhase: {
        mission:
          "Validate that suggested improvements are feasible and beneficial",
  ...
  },
  {
    ...
    data: {
      metadata: {
        ...
        name: "Security Auditor",
        description:
          "Identifies security vulnerabilities and recommends mitigation strategies",
        version: 1,
        capabilities: [
          "security-analysis",
      ...
      mission:
        "Identify security vulnerabilities, assess risk levels, and provide actionable remediation guidance for code, configurations, and infrastructure.",
      guidancePhase: {
        mission:
        ...
        example:
          '{"vulnerabilities": [{"type": "XSS", "severity": "high", "location": "line 42"}]}',
      },
      validationPhase: {
        mission:
          "Validate vulnerability reports and assess remediation feasibility",
  ...
  },
  {
    ...
    data: {
      ...
      mission:
        "Validate input data for completeness, correctness, format compliance, and business rule adherence. Flag anomalies and inconsistencies.",
      guidancePhase: {
        ...
        example:
          '{"valid": false, "errors": [{"field": "email", "issue": "invalid format"}]}',
      },
  ...
  },
  {
    ...
    data: {
      metadata: {
        ...
        name: "Content Summarizer",
        description:
          "Generates accurate, concise summaries while preserving key information",
        version: 1,
        capabilities: ["summarization", "key-extraction", "content-analysis"],
      },
      mission:
        "Create clear, concise summaries that capture essential information, main points, and key takeaways from longer content while maintaining accuracy.",
      guidancePhase: {
        ...
        example:
          '{"summary": "...", "key_points": ["Point 1", "Point 2"], "themes": ["Theme 1"]}',
      },
      validationPhase: {
  ...
  },
  {
    ...
    data: {
      metadata: {
        ...
        name: "User Guidance Assistant",
        description:
          "Offers strategic guidance and recommendations based on user context and goals",
        version: 1,
        capabilities: ["guidance", "recommendations", "decision-support"],
      },
      mission:
        "Provide clear, actionable guidance that helps users make informed decisions. Offer recommendations aligned with their goals, constraints, and context.",
      guidancePhase: {
        ...
        example:
          '{"recommendations": ["Step 1", "Step 2"], "alternatives": ["Option B"]}',
      },
      validationPhase: {
        mission:
          "Validate recommendations are safe and aligned with user goals",
