...
3. Provide confidence score (0-100)`,
    ...
    const pipelineTemplates = [
      ...
      },
      {
        ...
        version: 1,
        description:
          "Complete workflow from requirements to documentation review",
        workflowJson: {
          steps: [
            { id: "start", eye: "navigator", next: "sharingan" },
            ...
            {
              id: "rinnegan_requirements",
              eye: "rinnegan",
              next: "user_approval_1",
            },
            {
              id: "user_approval_1",
              type: "user_input",
              prompt: "Review and approve requirements",
              next: "conditional_2",
            },
            {
              id: "conditional_2",
            ...
            { id: "rinnegan_plan", eye: "rinnegan", next: "user_approval_2" },
            {
              id: "user_approval_2",
              type: "user_input",
              prompt: "Review and approve plan",
              next: "conditional_3",
            },
            {
              id: "conditional_3",
        ...
        workflowJson: {
          steps: [
            ...
            },
            {
              id: "user_fix",
              type: "user_input",
              prompt: "Fix documentation issues",
              next: "tenseigan",
            },
            { id: "end", type: "terminal" },
          ],
